...
async def on_message(message):
    ...
    if ("toasty" in lowercase or "bot" in lowercase) and ("down" in lowercase or "not working" in lowercase or "dead" in lowercase) and message.author != client.user and message.channel.id == "303203727362490368":
